    ...
    "definitions": {
        ...
        "github_com_norlis_hydra_internal_topology.Node": {
            ...
            "properties": {
                ...
                "labels": {
                    "description": "Labels allows injecting arbitrary metadata without changing the\nstruct (extensibility). E.g. {\"provider\": \"aws\", \"role\": \"edge-proxy\"}.",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
