...
// Tunnel is a soft limit on simultaneously-open tunnels. Zero limit
...
// New builds a Tunnel limiter with the given cap. limit <= 0 means
// "no cap" — Acquire/Release become free atomic-skip paths so callers
// don't need to special-case it.
func New(limit int) *Tunnel {
	return &Tunnel{limit: int64(limit)}
}
...
func (t *Tunnel) Limit() int64 { return t.limit }
